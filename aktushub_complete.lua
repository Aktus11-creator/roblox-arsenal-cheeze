...
GunmodsSection:NewToggle("Infinite Ammo v1.00001", "?", function(K)
    SettingsInfinite = K
...
GunmodsSection:NewToggle("Instant Reload", "?", function(x)
...
GunmodsSection:NewToggle("Rapid Fire", "?", function(state)
...
-- i had to modify the whole thing to be toggabled =w=
